...
import {HttpClientModule} from '@angular/common/http'; // se imporata esta clase http para poder hacer peticiones http
...
@NgModule({
  ...
  imports: [
    BrowserModule,
    AppRoutingModule,
    HttpClientModule, // se inicializa el modulo http para poder hacer peticiones http
    FormsModule,
    ReactiveFormsModule,
